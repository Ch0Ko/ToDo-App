...
export const ToDo = () => {
    ...
    const [todos, setTodos] = useState([
        {id: 1, name: 'Todo 1', title:'Gym',description:'Use the Treadmill',checked:false,time:((format(Date.now(),'dd.MM.yyyy -hh:mm')))},
        {id: 2, name: 'Todo 2', title:'Dinner',description:'Eat Sala', checked: false,time:((format(Date.now(),'dd.MM.yyyy -hh:mm')))}
    ]);
